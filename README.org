...
<table border="1">
  ...
  <tr>
    <th>Goal</th>
    <th>Varibles & Functions</th>
    <th>Documentation</th>
  </tr>
  <tr>
    <td>Choose how to load the macro.</td>
    <td>`org-utf-to-xetex-setup-file'</td>
    <td>Must configure before use by calling `'`org-utf-to-xetex-use-local-macro', `org-utf-to-xetex-use-remote-macro', or `org-utf-to-xetex-use-custom-macro'.</td>
  </tr>
  <tr>
