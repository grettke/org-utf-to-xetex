...
Add some Unicode characters to the both =new.ltx and =new.orgtest document. For example =A 我-⍋+☀APPLE🙋ZEBRA=. Compile them. White boxes will appear for some of the characters you entered. This is how you know that XeTeX doesn't know what fonts to use for all of the Unicode blocks right now.
...
Wrap =🙋= in the macro from this package by highlightig it and calling =org-utf-to-xetex-insert-or-wrap-with-macro=.
