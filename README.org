...
|------------------+-------------------------------------------------------------------------------------------|
| Org-Mode Source  | <img src="./images/orgfile.png" alt="Org-Mode Source File">                               |
| LaTeX Source     | <img src="./images/latexfile.png" alt="LaTeX Source File">                                |
| Generated PDF    | <img src="./images/pdffile.png" alt="PDF Without Using Package" width="62%" height="62%"> |
