...
#+BEGIN_QUOTE
Initially setting up this workflow  might feel intimidating but remember that #1 if /I/ can set it up than *anybody* can set it up and #2 learning this technology will completely empower you to use Org mode with *any* Unicode characters here forward. This technology completely frees you from WYSIWIG editors and lets you truly "Organize Your Life In Plain [Unicode] Text" for the rest of your life.
#+END_QUOTE
...
For every white box that you want replaced with a real character you'll need to go through the following steps. For sake of this example it will go through the entire process for the character =🙋=.
