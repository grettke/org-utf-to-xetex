...
- Load it.
- Configure the macro file source before using.
- Add it to your Org-Mode hook.

#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path "~/src/org-utf-to-xetex")
(require 'org-utf-to-xetex)
;; 99% of you will use the macro included with this package
(org-utf-to-xetex-use-local-macro)
;; or remotely (org-utf-to-xetex-use-remote-macro)
;; or (org-utf-to-xetex-use-custom-macro "~/tmp/tmp.setup")
...
ls
# Safeguard against any future unexpected changes
...
Move your cursor to the first line of the document.

You should have already configured your desired macro by adding one of the following to your init file:

- ~(org-utf-to-xetex-use-local-macro)~
- ~(org-utf-to-xetex-use-remote-macro)~
- ~(org-utf-to-xetex-use-custom-macro "file/path/here")~
  - When you have a custom macro you want to use, this is how to do it. For example if you want to limit the macro to different ~'latex~ exporters intermittently then this is a good place to do it.

Install the macro from this package calling the =org-utf-to-xetex-insert-setup-file-line= function. Based upon your macro choice the appropriate load statement will be inserted:


[[file:/images/workflow-macro-install-melpa.png]]


[[file:/images/workflow-macro-install-local.png]]


[[file:/images/workflow-macro-install-remote.png]]


With the cursor on ~#+SETUPFILE~ line that was just inserted and hit ~C-c C-c~ so that Org-Mode will refresh its setup. Now your document can use the macro.
...
|--------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------+---|
| Where should I load the macro file?                                                              | ~org-utf-to-xetex-use-local-macro)~, ~(org-utf-to-xetex-use-remote-macro)~, ~(org-utf-to-xetex-use-custom-macro "...")~ | Must perform before use.                                                                        |   |
...
#+begin_src sh
Running 26 tests (2025-03-19 19:01:17-0500, selector ‘t’)
   passed   1/26  org-utf-to-xetex--block-to-declaretextfontcommand (0.000155 sec)
   passed   2/26  org-utf-to-xetex--block-to-friendly-name (0.000267 sec)
   passed   3/26  org-utf-to-xetex--block-to-newfontfamily (0.000051 sec)
   passed   4/26  org-utf-to-xetex--block-to-textfontcommand (0.000037 sec)
   passed   5/26  org-utf-to-xetex--char-to-block-def (0.025022 sec)
   passed   6/26  org-utf-to-xetex--char-to-xetex (0.002741 sec)
   passed   7/26  org-utf-to-xetex--valid-char (0.000051 sec)
   passed   8/26  org-utf-to-xetex-string-to-xetex (0.064695 sec)
   passed   9/26  org-utf-to-xetex-test-existence-1 (0.000049 sec)
   passed  10/26  org-utf-to-xetex-test-existence-10 (0.000042 sec)
   passed  11/26  org-utf-to-xetex-test-existence-11 (0.000036 sec)
   passed  12/26  org-utf-to-xetex-test-existence-12 (0.000034 sec)
   passed  13/26  org-utf-to-xetex-test-existence-13 (0.000032 sec)
   passed  14/26  org-utf-to-xetex-test-existence-14 (0.000032 sec)
   passed  15/26  org-utf-to-xetex-test-existence-15 (0.000031 sec)
   passed  16/26  org-utf-to-xetex-test-existence-16 (0.000032 sec)
   passed  17/26  org-utf-to-xetex-test-existence-17 (0.000031 sec)
   passed  18/26  org-utf-to-xetex-test-existence-18 (0.000032 sec)
   passed  19/26  org-utf-to-xetex-test-existence-2 (0.000031 sec)
   passed  20/26  org-utf-to-xetex-test-existence-3 (0.000031 sec)
   passed  21/26  org-utf-to-xetex-test-existence-4 (0.000031 sec)
   passed  22/26  org-utf-to-xetex-test-existence-5 (0.000032 sec)
   passed  23/26  org-utf-to-xetex-test-existence-6 (0.000031 sec)
   passed  24/26  org-utf-to-xetex-test-existence-7 (0.000031 sec)
   passed  25/26  org-utf-to-xetex-test-existence-8 (0.000031 sec)
   passed  26/26  org-utf-to-xetex-test-existence-9 (0.000032 sec)

Ran 26 tests, 26 results as expected, 0 unexpected (2025-03-19 19:01:17-0500, 0.095039 sec)
#+end_src
