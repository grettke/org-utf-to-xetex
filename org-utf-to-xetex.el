...
(defconst org-utf-to-xetex-blocks
  '(
    ...
    ("Vithkuqi" #x10570 #x105BF)
    ("Todhri" #x105C0 #x105FF)
    ("Linear A" #x10600 #x1077F)
    ("Latin Extended-F" #x10780 #x107BF)
    ...
    ("Arabic Extended-C" #x10EC0 #x10EFF)
    ("Old Sogdian" #x10F00 #x10F2F)
    ("Sogdian" #x10F30 #x10F6F)
    ("Old Uyghur" #x10F70 #x10FAF)
    ...
    ("Takri" #x11680 #x116CF)
    ("Myanmar Extended-C" #x116D0 #x116FF)
    ("Ahom" #x11700 #x1174F)
    ("Dogra" #x11800 #x1184F)
    ...
    ("Unified Canadian Aboriginal Syllabics Extended-A" #x11AB0 #x11ABF)
    ("Pau Cin Hau" #x11AC0 #x11AFF)
    ("Devanagari Extended-A" #x11B00 #x11B5F)
    ("Sunuwar" #x11BC0 #x11BFF)
    ...
    ("Cypro-Minoan" #x12F90 #x12FFF)
    ("Egyptian Hieroglyphs" #x13000 #x1342F)
    ("Egyptian Hieroglyph Format Controls" #x13430 #x1345F)
    ("Egyptian Hieroglyphs Extended-A" #x13460 #x143FF)
    ("Anatolian Hieroglyphs" #x14400 #x1467F)
    ("Gurung Khema" #x16100 #x1613F)
    ("Bamum Supplement" #x16800 #x16A3F)
    ("Mro" #x16A40 #x16A6F)
    ("Tangsa" #x16A70 #x16ACF)
    ("Bassa Vah" #x16AD0 #x16AFF)
    ("Pahawh Hmong" #x16B00 #x16B8F)
    ("Kirat Rai" #x16D40 #x16D7F)
    ...
    ("Tangut Supplement" #x18D00 #x18D7F)
    ("Kana Extended-B" #x1AFF0 #x1AFFF)
    ...
    ("Symbols for Legacy Computing Supplement" #x1CC00 #x1CEBF)
    ("Znamenny Musical Notation" #x1CF00 #x1CFCF)
    ("Byzantine Musical Symbols" #x1D000 #x1D0FF)
    ("Musical Symbols" #x1D100 #x1D1FF)
    ("Ancient Greek Musical Notation" #x1D200 #x1D24F)
    ("Kaktovik Numerals" #x1D2C0 #x1D2DF)
    ...
    ("Latin Extended-G" #x1DF00 #x1DFFF)
    ("Glagolitic Supplement" #x1E000 #x1E02F)
    ("Cyrillic Extended-D" #x1E030 #x1E08F)
    ("Nyiakeng Puachue Hmong" #x1E100 #x1E14F)
    ("Toto" #x1E290 #x1E2BF)
    ("Wancho" #x1E2C0 #x1E2FF)
    ("Nag Mundari" #x1E4D0 #x1E4FF)
    ("Ol Onal" #x1E5D0 #x1E5FF)
    ("Ethiopic Extended-B" #x1E7E0 #x1E7FF)
